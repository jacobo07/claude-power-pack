...
wrote ~\AppData\Local\Temp\ceps-full-cycle-x5ve2ltn\tests\ceps_generated\test_182b990097ec.py
...
## CEPS edge 6/6
```
[isolate] tmp=~\AppData\Local\Temp\ceps-edge-ik6ngs_i
...
## TIS core 6/6
```
[isolate] tmp=~\AppData\Local\Temp\tis-core-2ld_w64e
...
## TIS E2E 4/4
```
[isolate] tmp=~\AppData\Local\Temp\tis-e2e-t85dy954
