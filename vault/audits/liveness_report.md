...
Generated 2026-07-10T16:38:16.455167+00:00 | 5 components | 4 LIVE, 1 non-LIVE (1 silent, 0 drifted, 0 orphaned, 0 unknown).
...
|---|---|---|---|
| `pm-03-bus` | pm-bus | **WIRED-BUT-SILENT** | 3 producer file(s) written, NO 'pm03_consume' consumer signal -- written, never read |
| `fd-07-flywheel` | stop-chain | **LIVE** | 98 signals, freshest 0.1h ago (<= 36h) |
| `fios-token-irr` | stop-chain | **LIVE** | 54 signals, freshest 0.1h ago (<= 36h) |
| `hook-dispatcher` | hooks-dir | **LIVE** | in sync (sha256 7afbbb78659e) |
| `kclaude-preflight` | kclaude | **LIVE** | SESSION_ZERO_2026-07-10T162015Z.md 0.3h ago (<= 36h) |
